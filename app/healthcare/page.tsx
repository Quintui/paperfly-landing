  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <div className="pt-[72px]">
        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Compliant RFPs for life-critical decisions.
              </motion.h1>
              <motion.p
              ...
              >
                Select clinical, med-tech, EHR, or facility vendors while
                meeting HIPAA / PHIPA obligations.
              </motion.p>
              <motion.div
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <h3 className="text-xl font-bold mb-2 text-[#005DF2]">
                  Cut procurement cycle time ~30–40%
                </h3>
              ...
              >
                ...
                <p className="text-gray-700">
                  —avoid exposing PHI in shared docs.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                ...
                <p className="text-gray-700">
                  (HIPAA BAA prompts, FDA 510(k) evidence fields).
                </p>
              </motion.div>
            </div>
          </div>
        ...
        {/* WHY PAPERFLY FOR HEALTHCARE SECTION */}
                ...
                <div className="bg-white/5 border border-white/10 p-8 rounded-2xl shadow-xl h-full">
                  ...
                  <ul className="space-y-6">
                    ...
                    <li className="flex items-start">
                      ...
                      />
                      <span>
                        Built-in checklists for device certifications,
                        interoperability (HL7 / FHIR), and privacy.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <FileCheck2
                      ...
                      />
                      <span>
                        Vendor portal timestamps submissions for audit trails
                ...
                <div className="bg-white/5 border border-white/10 p-8 rounded-2xl shadow-xl h-full">
                  ...
                  <ul className="space-y-6">
                    <li className="flex items-start">
                      ...
                      <span>Section ownership for every department.</span>
                    </li>
                    <li className="flex items-start">
                      <ClipboardCheck
                      ...
                      />
                      <span>
                        Certification and interoperability checklists built in.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <FileCheck2
                      ...
                      />
                      <span>
                        Timestamped vendor submissions for audit and
                        accreditation.
                      </span>
                    </li>
                  </ul>
            ...
            <div className="max-w-6xl mx-auto bg-blue-50 border border-blue-100 rounded-2xl p-0 md:p-0 shadow-lg flex flex-col md:flex-row items-center md:items-stretch">
              ...
              <div className="flex-1 p-10 flex flex-col justify-center">
                <h3 className="text-2xl font-bold text-[#005DF2] mb-4">
                  Regional Health Network Example
                </h3>
                <p className="text-lg text-gray-800 mb-0">
                  A regional health network must replace bedside monitors across
                  four hospitals. Nursing input, Biomedical specs, and Privacy
                  requirements converge in one Paperfly RFP. Vendors that lack
                  current FDA 510(k) clearance are auto-flagged—saving weeks of
                  manual vetting.
                </p>
              </div>
              {/* Right: Big Icon */}
              <div className="flex-1 flex items-center justify-center bg-[#005DF2] rounded-b-2xl md:rounded-b-none md:rounded-r-2xl p-10">
                <HeartPulse className="text-white" size={120} />
              </div>
            </div>
          </div>
        </section>
                ...
                <div className="md:w-1/2 p-8 md:p-12 flex items-center">
                  <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                      Get Started with Healthcare RFPs
                    </h2>
                    <p className="text-xl text-white/90 mb-8">
                      Ready to streamline your healthcare procurement and
                      compliance? Create compliant RFPs and RFIs in minutes —
                      not days.
                    </p>
