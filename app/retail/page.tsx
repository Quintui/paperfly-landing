        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              >
                Merchandising to last-mile—choose partners faster.
              </motion.h1>
              <motion.p
              ...
              >
                Unify procurement, merchandising, e-com, and logistics teams
                when seasonal velocity matters.
              </motion.p>
              <motion.div
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <h3 className="text-xl font-bold mb-2 text-[#005DF2]">
                  ~20–30% faster product-launch cycles
                </h3>
                <p className="text-gray-700">
                  Shorten procurement’s impact on product-launch cycles.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <h3 className="text-xl font-bold mb-2 text-[#005DF2]">
                  Margin-aware comparisons
                </h3>
                <p className="text-gray-700">
                  —evaluate vendor pricing against target GMROI.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <h3 className="text-xl font-bold mb-2 text-[#005DF2]">
                  Store + e-commerce spec tracking
                </h3>
                <p className="text-gray-700">in one template.</p>
              </motion.div>
            </div>
          </div>
        </section>

        {/* WHY PAPERFLY FOR RETAIL SECTION */}
                ...
                <div className="bg-white/5 border border-white/10 p-8 rounded-2xl shadow-xl h-full">
                  ...
                  <ul className="space-y-6">
                    <li className="flex items-start">
                      ...
                      />
                      <span>
                        Import SKU lists or planograms; vendors respond at
                        scale.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      />
                      <span>
                        Auto-score OTIF (On-Time-In-Full) and service-level
                        metrics.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <Truck className="text-[#60a5fa] mt-1 mr-3" size={20} />
                      <span>
                        Compare freight models, cut-off times, surge capacity
                        (holiday / promo windows).
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-8 rounded-2xl shadow-xl h-full">
                  ...
                  <ul className="space-y-6">
                    <li className="flex items-start">
                      ...
                      />
                      <span>
                        SKU and planogram import for vendor response at scale.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <ClipboardCheck
                        ...
                        size={20}
                      />
                      <span>Automated OTIF and service-level scoring.</span>
                    </li>
                    <li className="flex items-start">
                      <Truck className="text-[#34d399] mt-1 mr-3" size={20} />
                      <span>
                        Freight, cut-off, and surge capacity comparisons.
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="max-w-6xl mx-auto bg-blue-50 border border-blue-100 rounded-2xl p-0 md:p-0 shadow-lg flex flex-col md:flex-row items-center md:items-stretch">
              ...
              <div className="flex-1 p-10 flex flex-col justify-center">
                <h3 className="text-2xl font-bold text-[#005DF2] mb-4">
                  National Retailer Example
                </h3>
                <p className="text-lg text-gray-800 mb-0">
                  A national retailer needs a 3PL before peak season. Paperfly
                  collects capacity data, cut-off schedules, and surcharge
                  tables from five providers; the margin view shows which
                  partner protects Black Friday delivery windows without eroding
                  promo margins.
                </p>
              </div>
              {/* Right: Big Icon */}
              <div className="flex-1 flex items-center justify-center bg-[#005DF2] rounded-b-2xl md:rounded-b-none md:rounded-r-2xl p-10">
                <ShoppingCart className="text-white" size={120} />
              </div>
            </div>
          </div>
        </section>
                ...
                <div className="md:w-1/2 p-8 md:p-12 flex items-center">
                  <div>
                    ...
                    <p className="text-xl text-white/90 mb-8">
                      Ready to unify procurement, merchandising, and logistics
                      for retail? Start a retail RFP and accelerate your next
                      launch.
                    </p>
