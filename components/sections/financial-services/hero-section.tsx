    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Financial Services RFP Creation & Vendor Evaluation — Precision for a
            Regulated Industry
          </motion.h1>
          <motion.p
          ...
          >
            In financial services, every procurement decision carries weight.
            Banks, insurance companies, credit unions, and investment firms
            operate under strict regulatory scrutiny, and vendor selection
            directly impacts compliance, security, and client trust.
          </motion.p>
          <motion.div
