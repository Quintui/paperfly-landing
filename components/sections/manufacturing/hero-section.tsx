    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Manufacturing RFP Creation & Supplier Evaluation — Built for Complex
            Supply Chains
          </motion.h1>
          <motion.p
          ...
          >
            Manufacturers face a constant balancing act — securing the right
            suppliers, materials, and services while maintaining quality,
            compliance, and cost efficiency. The stakes are high, and the
            procurement process must be fast, transparent, and precise to keep
