    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Retail RFP Creation & Vendor Evaluation — Faster Sourcing for a Competitive Market
          </motion.h1>
          <motion.p
          ...
          >
            In retail, speed and accuracy in procurement directly impact product availability, store performance, and customer experience. Whether you’re sourcing inventory, logistics providers, point-of-sale systems, or store fixtures, retail procurement must move quickly while balancing cost, quality, and brand standards.
          </motion.p>
          <motion.div
