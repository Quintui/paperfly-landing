    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Non-Profit RFP Creation & Vendor Evaluation — More Impact, Less
          ...
          >
            Non-profits operate under unique pressures — balancing
            mission-driven goals with operational efficiency, donor
            accountability, and regulatory compliance. Paperfly enables
            non-profits to create bilingual RFPs, collect vendor responses in a
            consistent format, and automatically score submissions — reducing
            administrative overhead while ensuring procurement decisions are
            transparent, fair, and mission-aligned.
          </motion.p>
          <motion.div
