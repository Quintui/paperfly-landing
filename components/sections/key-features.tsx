...
export const KeyFeatures = () => {
  ...
  const features = [
    {
      ...
      description: "Upload meeting notes or documents — our AI extracts key details to auto-fill your RFP or RFI."
    },
    {
      icon: <Zap size={24} />,
    ...
    },
    {
      ...
      description: "Review, customize, or delete sections — no need to start from scratch."
    },
    {
      icon: <FileText size={24} />,
      title: "Instant Vendor Forms",
      description: "Automatically turn your final document into a vendor-ready questionnaire."
    }
  ];
  ...
  return (
    <section id="features" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-50 rounded-full opacity-70"></div>
