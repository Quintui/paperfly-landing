    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Higher Education RFP Creation & Vendor Evaluation
          </motion.h1>
          <motion.p
          ...
          >
            Simplify vendor management, procurement, and strategic planning for
            educational institutions. From LMS platforms to lab equipment, get
            stakeholders aligned and decisions documented efficiently.
          </motion.p>
          <motion.div
